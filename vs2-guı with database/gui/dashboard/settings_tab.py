...
class SettingsTab:
    ...
    def _change_username(self):
        ...
        popup.title("change  the your username")
        ...
        def save_username():
            ...
            if not new_username:
                MessageBox.show_error(popup, "error", "your name not be allowed empty")
                return
            
            success, message = db.change_username(new_username)
            
            if success:
                MessageBox.show_success(popup, "succes", message)
                popup.destroy()
            else:
    ...
    def _change_password(self):
        ...
        confirm_password = ctk.CTkEntry(
            popup,
            placeholder_text="please re-enter your password",
            width=400,
            height=40,
            corner_radius=10,
            show="*",
        ...
        def save_password():
            ...
            if not old_pass or not new_pass or not confirm_pass:
                MessageBox.show_error(popup, "error", "Fill in all fields.")
                return
            
            if new_pass != confirm_pass:
                MessageBox.show_error(popup, "error", "new password doen ton match")
                return
    ...
    def _delete_account(self):
        ...
        def delete_account():
            ...
            if not password:
                MessageBox.show_error(popup, "error", "enter the password")
                return
